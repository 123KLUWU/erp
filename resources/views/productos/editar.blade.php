...
@section('content')
    <div class="container">
        <div class="col-md-auto col-lg-auto">
            <center><h1>Editar Producto</h1></center> <form action="{{ route('catalogo.update', $producto->id) }}" method="POST"  class="row g-3"> @csrf
                    ...
                    <div class="input-group">
                        <select
                            ...
                            @foreach($unidadesdecompra as $unidad)
                                <option value="{{ $unidad->id }}" {{ old('unidad_de_compra_id', $producto->unidad_de_compra_id) == $unidad->id ? 'selected' : '' }} data-unidad="{{ $unidad->unidad }}" data-abreviacion="({{ $unidad->abreviacion }})">
                    ...
                    <div class="input-group">
                        <select
                            ...
                            @foreach($tallas as $talla)
                                <option value="{{ $talla->id }}" {{ old('talla_id', $producto->talla_id) == $talla->id ? 'selected' : '' }}>
                                    {{ $talla->talla }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-group">
                        <select
                            ...
                            @foreach($cortes as $corte)
                                <option value="{{ $corte->id }}" {{ old('corte_id', $producto->corte_id) == $corte->id ? 'selected' : '' }}>
                                    {{ $corte->corte }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-group">
                        <select
                            ...
                            @foreach($niveles as $nivel)
                                <option value="{{ $nivel->id }}" {{ old('nivel_id', $producto->nivel_id) == $nivel->id ? 'selected' : '' }}>
                                    {{ $nivel->nivel }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" id="descripcion" rows="3">{{ old('descripcion', $producto->descripcion) }}</textarea>
                    @error('descripcion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="card-body" id="bodyPrecios">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="costo_neto" name="costo_neto"
                                readonly value="{{ old('costo_neto', $precios ? $precios->costo_neto : '') }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="utilidad" name="utilidad"
                                value="{{ old('utilidad', $precios ? $precios->utilidad : '30') }}" placeholder="0.00">
                        </div>
                        <div class="mb-3">
                            <label for="precio" class="form-label">Precio</label>
                            <input type="number" step="0.01" class="form-control" id="precio" name="precio"
                                readonly value="{{ old('precio', $precios ? $precios->precio : '') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body" id="bodyStock">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="existencias" name="existencias" value="{{ old('existencias', $stock ? $stock->existencias : '0') }}">
                        </div>
                        <div class="mb-3">
                            <label for="ordenadas" class="form-label">Ordenadas</label>
                            <input type="number" class="form-control" id="ordenadas" name="ordenadas" value="{{ old('ordenadas', $stock ? $stock->ordenadas : '0') }}">
                        </div>
                        <div class="mb-3">
                            <label for="stock" class="form-label">Stock</label>
                            <input type="number" class="form-control" id="stock" name="stock" value="{{ old('stock', $stock ? $stock->stock : '0') }}">
                        </div>
                        <div class="mb-3">
                            <label for="ultima_compra" class="form-label">Última Compra</label>
                            <input type="date" class="form-control" id="ultima_compra" name="ultima_compra" value="{{ old('ultima_compra', $stock ? $stock->ultima_compra : '') }}">
                        </div>
                        <div class="mb-3">
                            <label for="max" class="form-label">Máximo</label>
                            <input type="number" class="form-control" id="max" name="max" value="{{ old('max', $stock ? $stock->max : '0') }}">
                        </div>
                        <div class="mb-3">
                            <label for="min" class="form-label">Mínimo</label>
                            <input type="number" class="form-control" id="min" name="min" value="{{ old('min', $stock ? $stock->min : '0') }}">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                <button class="btn btn-primary" type="submit" name="actualizar">Guardar Cambios</button> </form>
                </div>
        </div>
    </div>
